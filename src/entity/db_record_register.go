...
type SIPRecordRegister struct {
	...
	// Source information
	SrcHost        string `gorm:"column:src_host;index" bson:"src_host" json:"src_host"`
	SrcPort        int    `gorm:"column:src_port" bson:"src_port" json:"src_port"`
	SrcAddr        string `gorm:"column:src_addr" bson:"src_addr" json:"src_addr"`
	SrcCountryName string `gorm:"column:src_country_name" bson:"src_country_name" json:"src_country_name"`
	SrcCityName    string `gorm:"column:src_city_name" bson:"src_city_name" json:"src_city_name"`
}
