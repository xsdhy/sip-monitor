...
import { DatePicker, Card, Table, Button, Row, Col, Spin, message } from 'antd';
...
function Home() {
    ...
    const transformDataForCharts = () => {
        ...
        callStats.forEach(stat => {
            ...
            chartData.push({ ip: stat.ip, type: '0xx', value: stat.hangup_code_0_count });
            chartData.push({ ip: stat.ip, type: '1xx', value: stat.hangup_code_1xx_count });
            chartData.push({ ip: stat.ip, type: '2xx', value: stat.hangup_code_2xx_count });
            chartData.push({ ip: stat.ip, type: '3xx', value: stat.hangup_code_3xx_count });
            chartData.push({ ip: stat.ip, type: '4xx', value: stat.hangup_code_4xx_count });
            chartData.push({ ip: stat.ip, type: '5xx', value: stat.hangup_code_5xx_count });
        });
